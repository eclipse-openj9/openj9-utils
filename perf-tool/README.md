...
| --- | --- | --- | ---- |
| start | monitorEvents, objectAllocEvents, exceptionEvents | Event Name | Start recording an event |
| stop | monitorEvents, objectAllocEvents, exceptionEvents | Event Name | Stop recording an event |
